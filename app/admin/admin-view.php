<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bem-vindo administrador, esta página mostra todos os usuários e administradores registrados na LinuxStore, você pode excluí-los se desejar.</p>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <?php else: ?>
                                <h2 class="text-center">Não há administradores cadastrados no sistema</h2>
                            <?php endif; ?>
                        </div>
