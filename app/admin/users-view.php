<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
                ...
                if(MysqlQuery::Eliminar("cliente", "id_cliente='$id_user'")){
                    echo '
                        <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                            ...
                            <p class="text-center">
                                O usuário foi removido do sistema com sucesso
                            </p>
                        </div>
                    ';
                }else{
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bem-vindo administrador, esta página mostra todos os usuários e administradores registrados, você pode excluí-los se desejar.</p>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            ...
                            <?php else: ?>
                                <h2 class="text-center">Não há usuários cadastrados no sistema</h2>
                            <?php endif; ?>
                        </div>
