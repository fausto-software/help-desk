...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><i class="fa fa-linux"></i>&nbsp;&nbsp;Help Desk Service EI</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="#!"><span class="glyphicon glyphicon-comment"></span>&nbsp;&nbsp;mensagens</a>
                        </li>
                        <li>
                            <a href="./index.php?view=configuracion"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Contexto</a>
                        </li> 
                        <?php endif; ?>
                        ...
                        <li>
                            <a href="admin.php?view=config"><i class="fa fa-cogs"></i> &nbsp; Contexto</a>
                        </li>
                        <?php endif; ?> 
                        <li class="divider"></li>
                        <li ><a href="./process/logout.php"><i class="fa fa-power-off"></i>&nbsp;&nbsp;Fechar Sessão</a></li>
                    </ul>
                </li>
            </ul>
            <?php endif; ?>
            <ul class=" nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="./index.php?view=soporte"><span class="glyphicon glyphicon-flag"></span>&nbsp;&nbsp;Suporte técnico</a>
                </li>

                <?php if(!isset($_SESSION['tipo']) && !isset($_SESSION['nombre'])): ?>
                <li>
                    <a href="./index.php?view=registro"><i class="fa fa-users"></i>&nbsp;&nbsp;Registo</a>
                </li>
                <li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-primary" id="myModalLabel">Bem vindo ao Help Desk Service EI</h4>
            </div>
          <form action="" method="POST" style="margin: 20px;">
              <div class="form-group">
                  <label><span class="glyphicon glyphicon-user"></span>&nbsp;Nome</label>
                  <input type="text" class="form-control" name="nombre_login" placeholder="Digite o seu nome" required=""/>
              </div>
              <div class="form-group">
                  <label><span class="glyphicon glyphicon-lock"></span>&nbsp;Senha</label>
                  <input type="password" class="form-control" name="contrasena_login" placeholder="Digite a sua senha" required=""/>
              </div>
              
              <p>Como você vai entrar?</p>
              <div class="radio">
                <label>
