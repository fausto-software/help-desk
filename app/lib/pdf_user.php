...
$pdf->Cell (0,5,utf8_decode('Help Desk Service EI'),0,1,'C');
$pdf->Cell (0,5,utf8_decode('Relatório de problema Por Ticket'),0,1,'C');
...
$pdf->Cell (0,5,utf8_decode('Informação do ticket #'.utf8_decode($reg['serie'])),0,1,'C');
...
$pdf->Cell (35,10,'Nome',1,0,'C',true);
