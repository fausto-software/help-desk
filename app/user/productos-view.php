  ...
  <div class="row">
      <div class="col-sm-12">
        ...
        <ul class="nav nav-tabs">
          <li class="active"><a href="#all_categori" data-toggle="tab"><i class="fa fa-bars"></i>&nbsp;&nbsp;Todas as categorias</a></li>
          <li><a href="#desktop" data-toggle="tab"><i class="fa fa-desktop"></i>&nbsp;&nbsp;Mesa</a></li>
          <li><a href="#laptos" data-toggle="tab"><i class="fa fa-laptop"></i>&nbsp;&nbsp;Laptops</a></li>
        </ul>
